  ...
  parse(text, path) {
    ...
    function buildMaterial(data) {
      ...
      if (material.specular)
        ColorManagement.toWorkingColorSpace(material.specular, SRGBColorSpace);
      if (material.emissive)
        ColorManagement.toWorkingColorSpace(material.emissive, SRGBColorSpace);
    ...
    function buildGeometryType(primitives, sources, vertices) {
      ...
      for (let p = 0; p < primitives.length; p++) {
        ...
        switch (primitive.type) {
          ...
          default:
            console.warn(
              "THREE.ColladaLoader: Unknown primitive type:",
              primitive.type,
            );
        }
