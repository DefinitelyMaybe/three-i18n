...
<iframe src="/editor?url=/manual/examples/gpw-data-viewer.html"></iframe>
...
<div class="threejs_center">![image](/resources/images/world.jpg)</div>
...
[씬 그래프에 관한 글](scenegraph.html)에서 배웠듯 육면체를 다른 [`THREE.Object3D`](/api/ko/core/Object3D)의 자식으로 두는 것도 한 가지 해결 방법이지만, 씬 그래프 요소가 많아지만 그만큼 성능이 떨어집니다.
...
위 코드에서는 각 데이터 좌표마다 [`MeshBasicMaterial`](/api/ko/materials/MeshBasicMaterial)와 [`Mesh`](/api/ko/objects/Mesh)를 생성했습니다. 그리고 `positionHelper`의 전역 좌표를 구해 [`Mesh`](/api/ko/objects/Mesh)에 적용하고, 데이터의 양만큼 이 mesh를 키웠죠.
...
<iframe src="/editor?url=/manual/examples/lots-of-objects-slow.html"></iframe>
...
<div class="threejs_center">
  ![image](/resources/images/bring-up-fps-meter.gif)
</div>

제 환경에서는 평균 프레임이 20fps보다 낮네요.

<div class="threejs_center">![image](/resources/images/fps-meter.gif)</div>
...
그리고 생성한 육면체를 전부 배열에 저장한 뒤 이 배열을 `BufferGeometryUtils.mergeGeometries`에 넘겨 하나의 geometry로 합쳤습니다.
...
<iframe src="/editor?url=/manual/examples/lots-of-objects-merged.html"></iframe>
...
<iframe src="/editor?url=/manual/examples/lots-of-objects-merged-vertexcolors.html"></iframe>
...
<span>Script:src="../resources/threejs-lots-of-objects.js"</span>
