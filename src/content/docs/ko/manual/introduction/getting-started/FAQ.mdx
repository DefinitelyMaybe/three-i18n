...
three.js 널리 쓰이는 포맷인 FBX, Collada 나 OBJ 도 지원합니다. 하지만 첫 프로젝트에서는 glTF 기반의 워크플로우로 작업해야 합니다. 더 자세한 내용은, [ loading 3D models](/manual/introduction/Loading-3D-models)를 참고하세요.
...
## three.js가 때때로 잘못된 입력에 대해 이상한 결과를 반환하는 이유는 무엇인가요?
