...
테스트를 돌려봤더니 잠시 멈췄다가 _out of memery_ 오류가 뜹니다 😅.
...
예제의 방법 대신 `RayCaster`를 써도 괜찮은 결과가 나올 수 있습니다. 따로 테스트를 해보진 않았지만, 대신 [복셀에 최적화된 raycaster](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.42.3443&rep=rep1&type=pdf)를 찾아 이걸 적용했습니다.
