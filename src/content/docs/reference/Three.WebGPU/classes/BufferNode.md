...
Defined in: [three/src/nodes/accessors/BufferNode.js:18](https://github.com/DefinitelyMaybe/three-i18n/blob/fa57b79433d1c349ffb23a78727299c8d4190136/three/src/nodes/accessors/BufferNode.js#L18)

A special type of uniform node which represents array-like data
as uniform buffers. The access usually happens via `element()`
which returns an instance of [ArrayElementNode](/reference/threewebgpu/classes/arrayelementnode/). For example:

```js
const bufferNode = buffer( array, 'mat4', count );
const matrixNode = bufferNode.element( index ); // access a matrix from the buffer
```
In general, it is recommended to use the more managed [UniformArrayNode](/reference/threewebgpu/classes/uniformarraynode/)
...
> **new BufferNode**(`value`, `bufferType`, `bufferCount`?): `BufferNode`

Defined in: [three/src/nodes/accessors/BufferNode.js:33](https://github.com/DefinitelyMaybe/three-i18n/blob/fa57b79433d1c349ffb23a78727299c8d4190136/three/src/nodes/accessors/BufferNode.js#L33)
...
Defined in: [three/src/nodes/accessors/BufferNode.js:20](https://github.com/DefinitelyMaybe/three-i18n/blob/fa57b79433d1c349ffb23a78727299c8d4190136/three/src/nodes/accessors/BufferNode.js#L20)
