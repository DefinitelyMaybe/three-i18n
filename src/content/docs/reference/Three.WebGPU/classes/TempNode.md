...
Defined in: [three/src/nodes/core/TempNode.js:11](https://github.com/DefinitelyMaybe/three-i18n/blob/fa57b79433d1c349ffb23a78727299c8d4190136/three/src/nodes/core/TempNode.js#L11)
...
- [`AssignNode`](/reference/threewebgpu/classes/assignnode/)
- [`EquirectUVNode`](/reference/threewebgpu/classes/equirectuvnode/)
- [`JoinNode`](/reference/threewebgpu/classes/joinnode/)
- [`MatcapUVNode`](/reference/threewebgpu/classes/matcapuvnode/)
- [`RotateNode`](/reference/threewebgpu/classes/rotatenode/)
- [`SetNode`](/reference/threewebgpu/classes/setnode/)
- [`BumpMapNode`](/reference/threewebgpu/classes/bumpmapnode/)
- [`ColorSpaceNode`](/reference/threewebgpu/classes/colorspacenode/)
- [`NormalMapNode`](/reference/threewebgpu/classes/normalmapnode/)
- [`PosterizeNode`](/reference/threewebgpu/classes/posterizenode/)
- [`ToneMappingNode`](/reference/threewebgpu/classes/tonemappingnode/)
- [`RenderOutputNode`](/reference/threewebgpu/classes/renderoutputnode/)
- [`PassNode`](/reference/threewebgpu/classes/passnode/)
- [`FunctionCallNode`](/reference/threewebgpu/classes/functioncallnode/)
- [`PMREMNode`](/reference/threewebgpu/classes/pmremnode/)

## Constructors

### Constructor

> **new TempNode**(`nodeType`): `TempNode`

Defined in: [three/src/nodes/core/TempNode.js:24](https://github.com/DefinitelyMaybe/three-i18n/blob/fa57b79433d1c349ffb23a78727299c8d4190136/three/src/nodes/core/TempNode.js#L24)
...
Defined in: [three/src/nodes/core/TempNode.js:13](https://github.com/DefinitelyMaybe/three-i18n/blob/fa57b79433d1c349ffb23a78727299c8d4190136/three/src/nodes/core/TempNode.js#L13)
