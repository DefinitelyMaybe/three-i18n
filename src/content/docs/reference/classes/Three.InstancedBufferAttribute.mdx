...
Defined in: three/src/core/InstancedBufferAttribute.js:8
...
- [`StorageInstancedBufferAttribute`](Three.WebGPU.StorageInstancedBufferAttribute.html)
...
Defined in: three/src/core/InstancedBufferAttribute.js:18
