...
For a loaded file though it's a little more work. Most loaders only return an [`Object3D`](/api/en/core/Object3D)
...
First we'll check if the object is an [`Object3D`](/api/en/core/Object3D) then track its geometry, material, and children
