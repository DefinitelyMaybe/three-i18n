...
of what normals _normally_ look like. If your normals don't look normal
...
<div class="threejs_center">
  ![image](/resources/images/standard-primitive-normals.jpg)
</div>
...
<div class="threejs_center">
  ![image](/resources/images/standard-primitive-uvs.jpg)
</div>
...
To check textures try a [`CanvasTexture`](/api/en/textures/CanvasTexture) or a [`DataTexture`](/api/en/textures/DataTexture) that you
know works.
...
<div class="threejs_center">
  ![image](/resources/images/inspect-matrices.gif)
</div>
...
with [`MeshBasicMaterial`](/api/en/materials/MeshBasicMaterial)? If you can then try it and make sure it shows
up as expected.
