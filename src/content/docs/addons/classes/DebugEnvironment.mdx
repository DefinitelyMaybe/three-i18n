...
Defined in: three/addons/environments/DebugEnvironment.js:30
...
A more appropriate setup for production is [RoomEnvironment](RoomEnvironment.html).
...
Defined in: three/addons/environments/DebugEnvironment.js:35
...
Defined in: three/addons/environments/DebugEnvironment.js:76
