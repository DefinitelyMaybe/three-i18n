...
Defined in: three/addons/webxr/XRButton.js:16
...
Compared to [ARButton](ARButton.html) and [VRButton](VRButton.html), this class will
...
Defined in: three/addons/webxr/XRButton.js:25
