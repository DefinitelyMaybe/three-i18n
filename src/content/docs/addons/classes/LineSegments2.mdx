...
Defined in: three/addons/lines/LineSegments2.js:232

A series of lines drawn between pairs of vertices.

This adds functionality beyond LineSegments, like arbitrary line width and changing width
to be in world units. [Line2](Line2.html) extends this object, forming a polyline instead of individual
segments.
...
Defined in: three/addons/lines/LineSegments2.js:239
...
Defined in: three/addons/lines/LineSegments2.js:254
