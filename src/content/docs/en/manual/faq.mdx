...
[ headless-gl](https://github.com/stackgl/headless-gl) and [ jsdom-global](https://github.com/rstacruz/jsdom-global), or by replacing components like `TextureLoader`
