...
For that we can take inspiration from _paletted graphics_.
...
[`Material.onBeforeCompile`](/api/en/materials/Material.onBeforeCompile).
...
A [`DataTexture`](/api/en/textures/DataTexture) let's us give a texture raw data. In this case
...
and with those changes it _seems_ like it works to me.
