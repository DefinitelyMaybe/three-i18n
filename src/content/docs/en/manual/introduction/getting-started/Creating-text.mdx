...
## 2. Use [CSS2DRenderer](examples/renderers/CSS2DRenderer) or [CSS3DRenderer](examples/renderers/CSS3DRenderer)
...
## 3. Draw text to canvas and use as a [Texture](api/textures/Texture)
...
See the [TextGeometry](examples/geometries/TextGeometry) page for more info on how this can be done, descriptions of each
