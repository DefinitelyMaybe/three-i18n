...
you passed in. <strong>This is strongly NOT RECOMMENDED</strong>. See below
...
etc... There are many cases where if we use `setPixelRatio` then our actual size will be different
