...
The page will be blank — you're ready to [create a scene](creating-a-scene.html).
...
<ul>
<li>[ Five Server](https://marketplace.visualstudio.com/items?itemName=yandeu.five-server) for Visual Studio Code</li>
<li>[ Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) for Visual Studio Code</li>
...
Some excellent third-party projects are available for three.js, too. These need to be installed separately — see [Libraries and Plugins](libraries-and-plugins).

## Next Steps

You're now ready to [create a scene](creating-a-scene.html).
